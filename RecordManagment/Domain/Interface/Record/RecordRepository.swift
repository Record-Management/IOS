...
protocol RecordRepository: Sendable {
    ...
    ///   - type: 기록 종류 (예: "DAILY", "EXERCISE", "HABIT")
    /// - Returns: 생성된 기록 DTO
    func create(form: RequestType, type: String) async throws(RecordRepositoryError) -> ResponseType
    ...
    ///   - type: 기록 종류 (예: "DAILY", "EXERCISE", "HABIT")
    /// - Returns: 수정된 기록 DTO
    func update(recordId: String, form: RequestType, type: String) async throws(RecordRepositoryError) -> ResponseType
    ...
    func delete(recordId: String, type: String) async throws(RecordRepositoryError) -> ResponseType
}
